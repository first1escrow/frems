...
$stores    = ($_SESSION['member_pDep'] == 7) ? array_merge($_datalist->Scrivener($_SESSION['member_id']), $_datalist->Realty($_SESSION['member_id'])) : $_datalist->allScrivenerRealty();
...
$smarty->assign('menu_caseStatus', [
    'N' => '未完成',
    'Y' => '已完成',
]);
$smarty->assign('caseStatus', 'N');

$smarty->assign('stores', $stores);
$smarty->assign('menu_scr', $menu_scr);
$smarty->assign('contract_bank', $contract_bank);
$smarty->display('salesPaymentInfom.inc.tpl', '', 'sales');
