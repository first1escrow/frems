...
if ($cat == 'sign') {
    $dateCat = ' cc.cSignDate';
} elseif ($cat == 'end') {
    $dateCat = ' cc.cEndDate';
} elseif ($cat == 'check_date') {
    $dateCat = ' inc.cInspetorTime';
}
...
function checkSales($arr, $pId, $conn)
{
    ...
    $sales = array_column(getOtherFeed3($arr['cCertifiedId']), 'salesId');
