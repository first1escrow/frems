...
for ($i=0; $i < count($list); $i++) { 
	$html .= '<tr>';
	// $html .= "<td></td>";
	$html .= "<td><input type=\"checkbox\" name=\"store[]\" class=\"ckStore\" value=\"".$list[$i]['bId']."\">".$list[$i]['bCode'].$list[$i]['brand'].$list[$i]['bStore']."</td>";
	$html .= "<td id=\"".$list[$i]['bId']."\">".getSalesHtml($list[$i]['bId'])."</td>";
	$html .= '</tr>';
}
$html .='</table>';
