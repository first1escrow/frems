...
//
$sql          = 'SELECT `uuid` FROM `tSMSWaitSend` WHERE `sSent` = "N";';
$rs           = $conn->Execute($sql);
$sms_generate = $rs->EOF ? 'none' : '';
##
...
$smarty->assign('pusher', $env['pusher']);
$smarty->assign('sms_generate', $sms_generate);
$smarty->assign('company', $company);
$smarty->assign('season', $season);
$smarty->assign('today', date('m/d'));
$smarty->assign('menu', $menu);
$smarty->display('feedback_sms_v1.inc.tpl', '', 'escrow');
