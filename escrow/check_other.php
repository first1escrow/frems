...
function checkCase3($cid,$bId,$bId1,$bId2){
	...
	if ($bId > 0) {
		...
		if ($branch['total'] < 3 && ($branch['brandId'] != 1 && $branch['brandId'] !=49)) {
			$msg .= $branch['brand'].$branch['Name']." 辦理案件尚未超過三件,服務費出款需依照服務費確認單辦理出款\r\n";
		}
	...
	if ($bId1 > 0) {
		...
		if ($branch1['total'] < 3 && ($branch1['brandId'] != 1 && $branch1['brandId'] !=49)) {
			$msg .= $branch1['brand'].$branch1['Name']." 辦理案件尚未超過三件,服務費出款需依照服務費確認單辦理出款\r\n";
		}
	}
	...
	if ($bId2 > 0) {
		...
		if ($branch2['total'] < 3 && ($branch2['brandId'] != 1 && $branch2['brandId'] !=49)) {
			$msg .= $branch2['brand'].$branch2['Name']." 辦理案件尚未超過三件,服務費出款需依照服務費確認單辦理出款\r\n";
		}
	}
