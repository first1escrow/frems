...
if ($rs->fields['cDBName'] == 'tContractBuyer' || $rs->fields['cDBName'] == 'tContractOthersB') {
	...
	$sql = "UPDATE tContractInvoiceExt SET cInvoiceMoney = 0,cInvoiceDonate=0 WHERE (cDBName='tContractBuyer' OR cDBName ='tContractOthersB') AND cCertifiedId = '".$cCertifiedId."'";
	...
	$sql = "UPDATE tContractInvoiceExt SET cInvoiceMoney = 0,cInvoiceDonate=0 WHERE (cDBName='tContractOwner' OR cDBName ='tContractOthersO') AND cCertifiedId = '".$cCertifiedId."'";
	...
	$sql = "UPDATE tContractInvoiceExt SET cInvoiceMoney = 0,cInvoiceDonate=0 WHERE (cDBName='tContractRealestate' OR cDBName ='tContractRealestate1' OR cDBName ='tContractRealestate2') AND cCertifiedId = '".$cCertifiedId."'";
	...
	$sql = "UPDATE tContractInvoiceExt SET cInvoiceMoney = 0,cInvoiceDonate=0 WHERE cDBName='tContractScrivener'  AND cCertifiedId = '".$cCertifiedId."'";
	$conn->Execute($sql);
	 // echo $sql."<br>";
}

$sql  = "DELETE FROM  tContractInterestExt WHERE cInvId ='".$id."' AND cInvId !=0";

$conn->Execute($sql);



$sql = "DELETE FROM tContractInvoiceExt  WHERE cId='".$id."'";
...
// echo "inv_dealing.php?cCertifiedId=".$cId."&cSignCategory=".$cSignCategory."";
// die;
header("location:inv_dealing.php?cCertifiedId=".$cid."&cSignCategory=".$cSignCategory."");
