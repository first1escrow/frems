<?php
    ...
    //unset($styleArray);
    //畫雙線
    $styleArray = ['borders' => ['left' => ['borderStyle' => PHPExcel_Style_Border::BORDER_DOUBLE, 'color' => ['rgb' => '000000']]]];
    $objPHPExcel->getActiveSheet()->getStyle('A15')->applyFromArray($styleArray);
    $objPHPExcel->getActiveSheet()->getStyle('D15')->applyFromArray($styleArray);
    unset($styleArray);

    $styleArray = ['borders' => ['bottom' => ['borderStyle' => PHPExcel_Style_Border::BORDER_DOUBLE, 'color' => ['rgb' => '000000']]]];
    ...
    //$styleArray = array('borders' => array(
    //                                        'top' => array('borderStyle' => PHPExcel_Style_Border::BORDER_NONE),
    //                                        'bottom' => array('borderStyle' => PHPExcel_Style_Border::BORDER_THIN,'color' => array('rgb' => '000000'),),
    //                                        ),
    //                    );
    //$objPHPExcel->getActiveSheet()->getStyle('A44:F44')->applyFromArray($styleArray);
    //unset($styleArray);
                                                                             ...
                                                                             //    ),
                                                                             //);
                                                                             //$objPHPExcel->getActiveSheet()->getStyle('E26')->applyFromArray($styleArray);
                                                                             //$objPHPExcel->getActiveSheet()->getStyle('B26')->applyFromArray($styleArray);
                                                                             //$objPHPExcel->getActiveSheet()->getStyle('C26')->applyFromArray($styleArray);
                                                                             #############################
                                                                             ##寬度
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('E' . $row, '簽約日期');
    $objPHPExcel->getActiveSheet()->setCellValue('F' . $row, $list[0]['cSignDate']);
    //列高
    ...
    $styleArray3 = ['borders' => [
        'top'    => ['borderStyle' => PHPExcel_Style_Border::BORDER_THIN, 'color' => ['rgb' => '000000']],
        'bottom' => ['borderStyle' => PHPExcel_Style_Border::BORDER_NONE],
        'left'   => ['borderStyle' => PHPExcel_Style_Border::BORDER_DOUBLE],
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('A' . $row, "請蓋仲介公司章及店長親簽"); //
    $objPHPExcel->getActiveSheet()->getStyle('A' . $row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::VERTICAL_CENTER);
    $objPHPExcel->getActiveSheet()->mergeCells("A" . $row . ":C" . $row);
    $objPHPExcel->getActiveSheet()->setCellValue('D' . $row, "請蓋仲介公司章及店長親簽"); //
