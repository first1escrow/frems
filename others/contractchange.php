...
write_log($cid . ':更改電子合約書位置->第一建經', "esc");
...
{
    $sql = 'SELECT bMobile FROM tBranchSms WHERE bBranch="' . $bid . '" AND bDefault="1" AND bNID NOT IN ("14","15") ORDER BY bNID,bId ASC;';
    $rs  = $conn->Execute($sql);
