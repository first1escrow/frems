...
require_once dirname(dirname(dirname(__DIR__))).'/web_addr.php' ;
require_once dirname(dirname(dirname(__DIR__))).'/bank/Classes/PHPExcel.php' ;
require_once dirname(dirname(dirname(__DIR__))).'/bank/Classes/PHPExcel/Writer/Excel2007.php' ;
