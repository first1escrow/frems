...
<div style="border:1px #CCC solid;width: 50% ;margin-top: 50px;padding:5px;">
    ...
    <form id="form1" name="form1" method="post" action="export_list_all_result.php" >
        ...
        <?php foreach ($CertifiedId as $key => $value):  ?>
            <div style="padding: 5px;">
                <span class=""><input type="checkbox" name="CertifiedId[]" value="<?=$value?>" id="CertifiedId<?=$value?>" ><label for="CertifiedId<?=$value?>"><span></span><?=$value?></label></span>
            </div>
