...
include_once dirname(__DIR__) . '/includes/first1Sales.php';
...
$menu_category2 = array('11' => '加盟(其他品牌)',12=>'加盟(台灣房屋)',13=>'加盟(優美地產)',1=>'加盟',2=>'直營',3=>'非仲介成交' );
...
$smarty->assign('menu_caregory', $menu_caregory) ;
$smarty->assign('menu_category2',$menu_category2);
...
if ($_SESSION['member_pDep'] == 7) {
	$smarty->display('salesBusiness_new.inc.tpl', '', 'sales') ;
}else{
	$smarty->display('charge_report3.inc.tpl', '', 'report') ;
}
