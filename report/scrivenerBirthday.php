...
if ($_POST) {
	...
	if ($_POST['cat'] == 1) {
		if ($_POST['realestate']) {
			include_once 'scrivenerBirthday_result.php';
		}else{
			include_once 'scrivenerBirthday_result3.php'; //排程算
		}
		
	}else{
		include_once 'scrivenerBirthday_result2.php';
	}
...
$smarty->display('scrivenerBirthday.inc.tpl', '', 'report') ;
