...
//             AND a.sId IN (2977, 2978, 2979, 2980, 2981);';
$sql = 'SELECT
            a.sId, a.sName, a.sOffice, a.sMobileNum, a.sCpZip1
        FROM
            tScrivener as a
        WHERE
            a.sCpZip1 IN ("' . implode('","', $all_zips) . '")
...
// exit;
$fh = __DIR__ . '/scrivenerDefault_20230315.txt';
...
$fh = __DIR__ . '/no_bank_for_scrivener_20230315.log';
foreach ($all as $v) {
    try {
