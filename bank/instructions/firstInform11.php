...
{
    global $pdf, $data_detail, $data, $certifiedId;
...
// $data_detail[0]['bTicketDelay'] = str_replace('-', '.', $data_detail[0]['bTicketDelay']);
$html = "本指示單係客戶第一建築經理(股)公司委請本行於" . $data_detail[0]['bTicketDelay'] . "日辦理開立本行支票，並已將該筆金額" . number_format($data['bMoney']) . "元存入本行" . $data['bReBank'] . "分行，今因故無法於本日辦理，請於收到本指示單後，將該筆款項存入客戶第一建經信託專戶原保證號碼:" . substr($data['bCertifiedId'], 0, 5) . "-" . $certifiedId . "。";
