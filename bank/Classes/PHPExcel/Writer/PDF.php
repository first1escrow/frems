...
class PHPExcel_Writer_PDF extends PHPExcel_Writer_HTML implements PHPExcel_Writer_IWriter {
    ...
    public function setPaperSize($pValue = PHPExcel_Worksheet_PageSetup::PAPERSIZE_A2_PAPER) {
	...
	public function save($pFilename = null) {
		...
		$paperSize = 'A2';	//	Letter	(8.5 in. by 11 in.)
		...
		$pdf->SetMargins($printMargins->getLeft() * 12,$printMargins->getTop() * 32,$printMargins->getRight() * 12);
		$pdf->SetAutoPageBreak(true,$printMargins->getBottom() * 32);
