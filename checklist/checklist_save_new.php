...
define('KEY', 'first1Escrow2TimeAuthKey3');
...
if ($preview) {
    ...
    echo 'window.open("http://10.10.1.199/case/' . $cCertifiedId . '/checklist/' . getAuth($cCertifiedId) . '","","width=800px,height=1200px,status=yes,scrollbars=yes,location=no,menubar=no,location=no") ;';
}
