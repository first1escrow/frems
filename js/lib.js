...
function CatchBranch(index) {
    ClearBranch(index);
    // console.log('CatchBranch_realestate_branchnum'+index+'_'+$('[name=realestate_branchnum'+index+']').val());
    // console.log('value'+$('[name=realestate_branchnum'+index+']').val());
    $.ajax({  
...
function addBankList(type){
    ...
    setComboboxBank(type+'_bankkey2','id');//再把combobox加回來
    setComboboxBank(type+'_bankbranch2','id');//再把combobox加回來
    setComboboxBank(type+'_bankkey'+no2,'id');
    setComboboxBank(type+'_bankbranch'+no2,'id');
}