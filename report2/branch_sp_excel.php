...
// $objPHPExcel->getActiveSheet()->getStyle('A11:B11')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID);
// $objPHPExcel->getActiveSheet()->getStyle('A11:B11')->getFill()->getStartColor()->setARGB('FDFF37');
...
// $objPHPExcel->getActiveSheet()->getStyle("J1:K1")->getFill()->getStartColor()->setARGB('FDFF37');
