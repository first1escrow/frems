...
class Base extends PDO
{
    ...
    {
        $dsn = 'mysql:dbname=' . $GLOBALS['DB_ESCROW_NAME'] . ';port=' . $GLOBALS['DB_ESCROW_PORT'] . ';host=' . $GLOBALS['DB_ESCROW_LOCATION'];
        try {
