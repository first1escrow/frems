...
class ExcelCs1 extends ExcelBase
{
    ...
    public function GenerateField()
    {
        ...
        foreach ($list_case as $k => $v) {
            ...
            if ($data_buyer['cInvoiceMoney'] > 0) {
                ...
                $arrItem[$index]['L'] = $arrItem[$index]['BQ'];
                //$arrItem[$index]['CC'] = $giver_num ;            //身分證字號或統一編號
                //$arrItem[$index]['CP'] = $v['cCertifiedId'] ;
                ##
