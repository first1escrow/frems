...
$(document).ready(function(){
	...
	$('#example tbody tr').live('dblclick', function () {
		...
		$('#myform').attr('action', 'newsModify.php');
		$('[name="sn"]').val(tmp);
		$('[name="op"]').val('m');
		$('#myform').submit();
	} );
...
<div style="margin:10px 10px 20px 10px;text-align:left;">
	<img onclick="closeNews()" style="cursor:pointer;" src="/images/close.png" title="關閉">
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
	<thead>
		<tr>
			<th style="width:500px;">文章主題</th>
			<th style="width:100px;">活動期間起</th>
			<th style="width:100px;">活動期間迄</th>
		</tr>
	</thead>
	<tbody>
		<tr>
