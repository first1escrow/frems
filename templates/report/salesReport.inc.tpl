...
<div id="subTabs">
	...
	<div id="subTabs-1">
		...
		<div>
			...
			<span style="font-weight:bold;color:#000088;"><{$oseasontarget}></span>
			%
			、
			得分：
		...
		<div>
			...
			<span style="font-weight:bold;color:#000088;"><{$oseasongroup}></span>
			%
			、
			得分：
			<span style="font-weight:bold;color:#000088;"><{$seasongroup}></span>
			分
		</div>
		
		<div>
			使用率：
			<span style="font-weight:bold;color:#000088;"><{$oseasonuse}></span>
			%
			、
			得分：
			<span style="font-weight:bold;color:#000088;"><{$seasonuse}></span>
			分
		</div>
		<{if $now_year <= 105}>
		<div>
			貢獻率：
			<span style="font-weight:bold;color:#000088;"><{$oseasoncontribution}></span>
			%
			、
			得分：
			<span style="font-weight:bold;color:#000088;"><{$seasoncontribution}></span>
			分
		</div>
		<{else}>
		<div>
			有效率：
			<span style="font-weight:bold;color:#000088;"><{$eff1.effective}></span>
			%
			、
			得分：
			<span style="font-weight:bold;color:#000088;"><{$eff1.score}></span>
			分
		</div>
		<{/if}>
	...
	<{if $now_year <= 105}>
	<div id="subTabs-5">
		<div><font color="red">※106年績效計算不會用到</font></div>
		<div id="tag4">
	...
	<div id="subTabs-7">
		...
		<{if $now_year ==106 && $sess == 1}>

		
		<div><font color="red">時間範圍：<{$eff1.range_start}>~<{$eff1.range_end}></font></div>
		<{else}>
			<div><font color="red">(A)時間範圍：<{$eff1.range_start2}>~<{$eff1.range_end2}></font></div>
			<div><font color="red">(B)時間範圍：<{$eff1.range_start}>~<{$eff1.range_end}></font></div>
		<{/if}>
