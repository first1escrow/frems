...
function first() {
	...
	post_data('salescase_result.php',current_page) ;
}
function back() {
...
function xls_ep() {	
	$('form[name="myform"]').attr('action','salescase_result.php') ;
	$('[name="xls"]').val('ok') ;
...
<tr style="background-color:#E4BEB1;line-height:24px;text-align:center;width:840px;">
	<td nowrap style="width:150px;border:0px;">總筆數</td>
...
<tr>
	<td colspan="5" style="height:40px;">
		<input type="button" class="bt4" value="回上一頁" onclick="go_back('sakescase.php')">
...
<tr style="background-color:#E4BeB1;text-align:center;">
	...
	<td style="width:80px;line-height:30px;">地政士</td>
	<td style="width:50px;line-height:30px;">狀態</td>
	<td style="width:50px;line-height:30px;">業務</td>
</tr>
<{$tbl}>
</table>
