    ...
    <head>
		...
		$(document).ready(function() {
			...
			$('#formList').on('click', function() {
				...
				{
					 var url = 'charge_report_excel3.php';
								...
								<tr>
									...
									<form name='form1'  method="POST">
										<table width="100%" border="0" cellpadding="4" cellspacing="0" align="center" style="margin-top:50px;margin-right:100px;">
											<tr style="background-color:#F8ECE9;"><td colspan="3" align="center"><h1>績效業務區域 業績統計表</h1></td></tr>
											<tr style="background-color:#F8ECE9;"><td width="25%" ></td><td style="padding:10px;"><label><input type="radio" name='date_type' value="1" checked> 簽約時間</label>	<label><input type="radio" name='date_type' value="2"> 履保費出款日</label></td><td width="25%"></td></tr>
										...
										<tr style="background-color:#F8ECE9;"><td></td>
											...
											<tr style="background-color:#F8ECE9;"><td></td><td style="padding:10px;"><label><input type='radio' name='report_type' value='1' checked> 單一業務比較</label>&nbsp;<label><input type="radio" name='report_type' value="2"> 多個業務比較</label></td><td></td></tr>
