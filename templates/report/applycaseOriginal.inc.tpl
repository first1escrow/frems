...
function go(url) {
	...
	$.post(url,
		...
		'cCertifiedId':cid,'buyer':byr,'owner':owr,'show_hide':'hide','scrivener_category':s_cat,'bApplication':bApplication},
		function(txt) {
			$('#container').html(txt) ;
			$( "#dialog" ).dialog("close") ;
	}) ;
...
<input type="button" value="查詢" onclick="go('applycaseOriginal_result.php')" class="bt4" style="display:;width:100px;height:35px;">
<input type="button" value="匯出 excel 檔" onclick="xls('applycaseOriginal_excel.php')" class="bt4" style="display:none;width:100px;height:35px;display:;">
</div>
</form>
</div>
