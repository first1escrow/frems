...
function go(url) {
	...
	$.post(url,
		...
		'cCertifiedId':cid,'buyer':byr,'owner':owr,'show_hide':'hide','sales':sales},
		function(txt) {
			$('#container').html(txt) ;
			$( "#dialog" ).dialog("close") ;
	}) ;
...
<tr>
	...
	<{html_options name="sales" options=$sales_option}>
	</td>
</tr>
</table>
<div style="padding:20px;text-align:center;">
<input type="button" value="查詢" onclick="go('salescase_result.php')" class="bt4" style="display:;width:100px;height:35px;">
<input type="button" value="匯出 excel 檔" onclick="xls('salescase_excel.php')" class="bt4" style="display:none;width:100px;height:35px;display:;">
</div>
</form>
</div>
