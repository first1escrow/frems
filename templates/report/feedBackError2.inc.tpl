...
<{if $smarty.session.member_id == 6 || $smarty.session.member_id == 1 || $smarty.session.member_id == 3}>
<tr>
	<td style="width:20%;background-color:#E4BEB1;padding:4px;">
	業務
            ...
            <tr>
               	...
               	<td>
               		<{if $item.cCaseFeedback == 0}>
               			回饋，金額：<span style="background-color:#CCC;"><{$item.cCaseFeedBackMoney|number_format:0}>元</span>
               		<{else}>
               			不回饋
               		<{/if}> 
               	</td>
            ...
            <tr >
             	...
             	<td>
             		<{if $item.cCaseFeedback1 == 0}>
               			回饋，金額：<span style="background-color:#CCC;"><{$item.cCaseFeedBackMoney1|number_format:0}>元</span>
               		<{else}>
               			不回饋
               		<{/if}> 
            ...
            <tr >
                ...
                <td>
                	<{if $item.cCaseFeedback2 == 0}>
               			回饋，金額：<span style="background-color:#CCC;"><{$item.cCaseFeedBackMoney2|number_format:0}>元</span>
               		<{else}>
               			不回饋
               		<{/if}> 
