								...
								<div>
									...
									<div style="margin:0px auto;width:500px;text-align:left;padding:10px;border:1px solid #ccc;">
										<div style="height:30px;">
											選擇身分
											<input type="radio" name="cat" value="branch" checked onclick="show('branch')">仲介店
											<input type="radio" name="cat" value="scrivener" onclick="show('scrivener')">地政士
										</div>
										...
										<div style="height:30px;" id="showB">
											<span style="margin-left:20px;">店家類型:</span>
											<span style="margin-left:20px;">
