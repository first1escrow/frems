...
function post_data(url,cp) {
	var url = 'applycaseOriginal_result.php' ;
	...
	var bApplication = $('[name="bApplication"]').val();
	...
	$.post(url,
		...
		'buyer':byr,'owner':owr,'total_page':tp,'record_limit':rl,'current_page':cp,'bApplication':bApplication},
		function(txt) {
			$('#container').html(txt) ;
	}) ;
}
...
function first() {
	...
	post_data('applycaseOriginal_result.php',current_page) ;
}
function back() {
...
function xls_ep() {	
	$('form[name="myform"]').attr('action','applycaseOriginal_result.php') ;
	$('[name="xls"]').val('ok') ;
	var max = "<{$max}>";
	max = max.replace(/,/, "");
...
<form method="post" name="myform">
	...
	<table cellspacing="0" cellpadding="0" style="width:600px;border-spacing:0px;">
	...
	<tr style="background-color:#E4BEB1;line-height:24px;text-align:center;width:840px;">
		<td nowrap style="width:150px;border:0px;">案件總筆數</td>
		<td nowrap style="width:180px;border:0px;">買賣總價金額</td>
		<td nowrap style="width:180px;border:0px;">合約總保證費金額</td>
		<td nowrap style="width:180px;border:0px;">出款總保證費金額</td>
		<td nowrap style="width:150px;border:0px;">功能</td>
	</tr>
	<tr style="line-height:24px;text-align:center;background-color:#F8ECE9;">
		<td style="width:150px;border:0px;"><{$max}>&nbsp;</td>
		<td nowrap style="width:180px;border:0px;"><{$totalMoney}>&nbsp;</td>
		<td nowrap style="width:180px;border:0px;"><{$certifiedMoney}>&nbsp;</td>
		<td nowrap style="width:180px;border:0px;"><{$transMoney}>&nbsp;</td>
		<td style="width:150px;border:0px;"><{$functions}>&nbsp;</td>
	</tr>
	<tr>
	...
	<input type="hidden" name="bApplication" value="<{$bApplication}>">
