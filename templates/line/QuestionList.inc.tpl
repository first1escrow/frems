...
$(document).ready(function() {
    ...
    $(document).on('dblclick','#example tbody tr', function () {
    	...
    	var url = 'QuestionEdit.php?id='+id+'&cat=2' ;
...
function Add(){
	var url = 'QuestionEdit.php?cat=1' ;
	$.colorbox({iframe:true, width:"60%", height:"90%", href:url,onClosed:function(){
	   location.href ='QuestionList.php';
	}}) ;
}
