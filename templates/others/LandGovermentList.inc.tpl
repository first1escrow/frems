...
$(document).ready(function() {
	...
	$("#example").dataTable({
        ...
        "bServerSide": true,
        "sServerMethod": "POST", 
        "sAjaxSource": "getLandGoverment.php",
    ...
    $(document).on('dblclick','#example tbody tr', function () {
    	...
    	var url = 'LandGovermentEdit.php?id='+id+'&cat=2' ;
	    $.colorbox({iframe:true, width:"1200px", height:"90%", href:url,onClosed:function(){
	        location.href ='LandGovermentList.php';
	    }}) ;
    });
...
function add(){
	var url = 'LandGovermentEdit.php?cat=1' ;
	$.colorbox({iframe:true, width:"1200px", height:"90%", href:url,onClosed:function(){
	   location.href ='LandGovermentList.php';
	}}) ;
}
