        ...
        <script type="text/javascript">
            $(document).ready(function() {
				...
				$('#export').live('click', function () {
                    let cat = $("[name='cat']:checked").val();

                    $('[name="form_search"]').attr('action', 'scrivener_report.php');
                    if (cat == 1) {
                        $('[name="form_search"]').attr('action', 'branch_report.php');
                    }
                        ...
                        <td width="753">
                            <table width="100%" border="0" align="right" cellpadding="3" cellspacing="3">
                                ...
                                <tr>
                                    ...
                                    </td><td width="5%" height="30" colspan="2">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label style="padding-right:20px;">
                                                            <input type="radio" name="cat" value="1" checked>仲介店
                                                        </label>
                                                        <label style="padding-right:20px;">
                                                            <input type="radio" name="cat" value="2">地政士
                                                        </label>
                                                    </td>
                                                </tr>
                                                <tr>
