                                                        ...
                                                        <table  border="0" cellpadding="0" cellspacing="0" class="tb">
                                                            <tr>
                                                                <td colspan="2" class="tb-title">
                                                                    出款建檔
                                                                    <input type="hidden" name="caseNo" value="<{$dataAllot.aOrderNO}>">
                                                                    <input type="hidden" name="id" value="<{$dataAllot.aId}>">
                                                                    <input type="hidden" name="bank" value="永豐">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th>角色：</th>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    *
                                                                    <input type="hidden" name="code2" id="code2" value="虛轉虛" />
                                                                    <select name="export" id="export">
                                                                        <option value="01" selected="selected">虛轉虛</option>
                                                                    </select>
                                                                    <br />
                                                                    *
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="167"><br />
                                                                    ...
                                                                    <textarea name="t_txt" id="t_txt" cols="20" class="t_txt" rows="5" ><{$data.tAccountId}></textarea>
                                                                </td>
                                                            </tr>
                                                            <tr>
