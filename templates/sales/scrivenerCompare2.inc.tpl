...
<div style="text-align:center;">
	...
	<form method="POST" id="myform" name="myform">
		...
		<div id="qScr" style="border:1px solid #CCC; width:300px;padding: 10px;">
			...
			<div>
				比對日期：<input type="text" id="qDate" name="qDate" value="<{$qDate}>" style="width:100px;" class="datepickerROC">至<input type="text" id="qDate2" name="qDate2" value="<{$qDate2}>" style="width:100px;" class="datepickerROC">
			</div>
