...
<head>
	...
	$(document).ready(function() {
		...
		$('#export').click(function() {
				...
				var url = 'salesBusinessExcel.php';
									...
									<form name='form1'  method="POST">
										<table width="100%" border="0" cellpadding="4" cellspacing="0" align="center" >
											<tr style="background-color:#F8ECE9;">
												<td width="25%" ></td><td style="padding:10px;"><input type="radio" name='date_type' value="1" checked>進案時間	<input type="radio" name='date_type' value="2">結案時間</td><td width="25%"></td>
											</tr>
											<tr style="background-color:#F8ECE9;">
												<td></td>
