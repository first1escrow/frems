...
<div id="subTabs">
	...
	<div id="subTabs-2">
		...
		<div id="tag11">
			<h2><{$now_year}>年度各季簽約數/達成率(<font color="red">本季達成率：<{$seasontarget}>%</font>)</h2>
			...
			<table cellspacing="0" cellpadding="0"  class="statistics">
				...
				<tr style="background-color:#F0FFF0;">
					...
					<{foreach from=$summary1 key=key item=item}>
						...
						<td class="<{$item.class}>" id="<{$now_month}>-<{$now_check}>">
	...
	<div id="subTabs-4">
		...
		<div id="tag31">
			<h2><{$now_year}>年度各季使用量/使用率(<font color="red">本季使用率：<{$seasonuse}>%</font>)</h2>
			<table cellspacing="0" cellpadding="0"  class="statistics_s">
				<thead>
					<tr>
						<th>季</th>
	...
	<div id="subTabs-5">
		...
		<div id="tag41">
			<h2><{$now_year}>年度各季貢獻率(<font color="red">本季貢獻率：<{$seasoncontribution}>%</font>)</h2>
			<table cellspacing="0" cellpadding="0"  class="statistics_s">
				<thead>
					<tr>
						<th>季</th>
