...
<head>
	...
	function areaDefault(ct, no) {
		...
		$.ajax({
			url: 'salesScrivenerAreaDefault.php',
			type: 'POST',
			dataType: 'html',
			data: {'s': sid, 'c': ct},
		})
	...
	function setArea(city){
		var url = "setAreaSales.php?cat='s'&city="+city ;
		$.colorbox({iframe: true,width: "600px",height: "500px",href: url,onClosed: function() {
							//$('#reloadPage').submit() ;
							location.href="/sales/salesScrivenerArea.php";
					}}) ;
	}
	function showCity(){
	...
	function searchB(){
		...
		$.ajax({
			url: 'salesScrivenerAreaAjax.php',
			type: 'POST',
			dataType: 'html',
	...
	function setDefault(){
		...
		sales_type[0] = $('[name="default_sales_type[]"]').val();
...
<body id="dt_example" >
    <div id="wrapper">
        ...
        <form name="exp" method="POST" action="salesScrivenerAreaExcel.php" target="_blank">
										...
										<div id="tabs">
			                                ...
			                                <div id="tabs-default">
												...
												<fieldset>
			    									...
			    									<div id="default"  style="padding: 20px;">
				                                		<!-- 類別: -->
				                                		<input type="hidden" name="default_sales_type[]" value="3" checked="checked">
					                                	<br>
					                                	業務:
			                                	...
			                                	<table cellpadding="0" cellspacing="0" width="100%" class="tb">
			                                		<tr>
			                                			<th width="50%"><input type="checkbox" name="default_all" value="all" onclick="checkAll()">區域</th>
			                                			<th width="50%">業務</th>
                                			...
                                			<div id="tabs-store">
                                				<div style="display:block;border:1px #000 solid; padding:5px;">
													...
													<div class="searchright">
														...
														<!-- <input type="button" id="export" class="btnC btnC3" value="EXCEL" onclick="export_xls()"> -->
													</div>	
													<div class="area"></div>
												</div>
                                			...
                                			<div id="tabs-note">
                                				<{if $smarty.session.member_id == 1 || $smarty.session.member_id == 6}>
													<iframe src="salesNote.php?cat=1" frameborder="0" height="800px" width="100%"></iframe>
                                				<{/if}>
                                			</div>
			                            </div>
