        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $("#example").dataTable({
                    ...
                    "bServerSide": true,
                    "sServerMethod": "POST", 
                    "sAjaxSource": "/includes/maintain/branchgrouplisttb.php",
                ...
                $('#example tbody tr').live('dblclick', function () {
                    ...
                    $('form[name=form_edit]').attr('action', '/maintain/formbranchgroupedit.php');
                    $('form[name=form_edit] input[name=id]').val(tmp);
                    $('form[name=form_edit]').submit();
                } );

                $('#add').live('click', function () {
                    $('form[name=form_add]').attr('action', '/maintain/formbranchgroupadd.php');
