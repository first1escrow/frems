        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $("#example").dataTable({
                    ...
                    "bServerSide": true,
                    "sServerMethod": "POST", 
                    "sAjaxSource": "/includes/maintain/brandlisttb.php",
                ...
                $('#example tbody tr').live('dblclick', function () {
                    ...
                    $('form[name=form_edit]').attr('action', '/maintain/formbrandedit.php');
                    $('form[name=form_edit] input[name=id]').val(tmp);
                    $('form[name=form_edit]').submit();
                } );

                $('#add').live('click', function () {
                    $('form[name=form_add]').attr('action', '/maintain/formbrandadd.php');
                                                                ...
                                                                <div id="container">
                                                                    <div id="dynamic">
                                                                        ...
                                                                        <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                                                                            <thead>
                                                                                <tr>
                                                                                    <th width="15%">仲介品牌編號</th>
                                                                                    <th width="35%">仲介品牌名稱</th>
                                                                                    <th width="35%">公司全名</th>
                                                                                    <th width="15%">統一編號</th>
                                                                                </tr>
                                                                            </thead>
